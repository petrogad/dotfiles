...
project-specific doc skill** that applies to the area you're researching.
...
- **`deep-research`** (or web search) for heavy, multi-source, fact-checked external research.
- **`gh`** and cross-repo code search for prior art, existing issues, and internal context.
